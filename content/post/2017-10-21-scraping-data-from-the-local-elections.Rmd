...
#Function to have the result for one commune.
  result = function(x){
  #scrapping data
  vote = read_html(paste("http://www.elections.public.lu/fr/elections-com  munales/2017/resultats/communes/",x,".html", sep="")) %>% 
...
I hope you enjoyed reading this post. Don't hesitate to contact me for any questions.
Follow rdata.lu on [twitter](https://twitter.com/rdata_lu?lang=en) and subscribe to the [youtube channel.](https://www.youtube.com/channel/UCbazvBnJd7CJ4WnTL6BI6qw) See you for the next post ;) <br>
