...
it is possible to plot them. The shapefile can be obtained from 
...
Now we can read the data, and to some basic cleaning. I comment every step, but run the code line
