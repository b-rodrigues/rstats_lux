...
by providing this function with name of the class of the object we're interested in, namely, the table.
...
characters. We need to convert each column to a numeric vector and this is what happens in the next line, `mutate_at(vars(matches("200*")), as.numeric)`.
